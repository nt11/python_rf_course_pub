...
class PA_App(QMainWindow):
    def __init__(self):
        ...
        # WSB_1: Fix the h_gui based on the widgets you just added to the UI file
        self.h_gui = dict(
    ...
    def tcb_plot(self, freq, power, clf= True,legend='Gain',color='b-'):
        ...
        #WSB_7: Plot the power vs frequency, set the x and y labels, title, line width to 3.0 and clear the plot
        #
